                    ...
                    <div className="container">
                        <div className="logo left">
                            <a href="#" title="Leapfrog Technology">
                                <img src={require("../assets/leapfrog-icon.svg")} alt="Leapfrog Technology" />
                            </a>
                        </div>
                        ...
                        <ul className="header-right right">
                            <li className="header-right__item">
                                <a href="#" title="Notifications">
                                    <img src={require("../assets/notification-icon.svg")} alt="Notifications" />
                                </a>
                            </li>
                            <li className="header-right__item">
                            ...
                            <li className="header-right__item">
                                <a href="#" title="Logout">
                                    <img src={require("../assets/logout-icon.svg")} alt="Logout" />
                                </a>
                            </li>
                        </ul>
                    </div>
